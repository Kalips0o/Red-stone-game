...
export function PlayerMana ({currentMana, maxMana, typePlayer}:Props){
  ...
  return <div className={cn("flex items-center absolute", {
    ...
    <Badge value={currentMana} maxValue={maxMana} color='blue' />
     ...
     {new Array(maxMana).fill(null).map((_, index) => (

      <div 
    key={index}
    className={cn('w-6 h-6 bg-gradient-to-t from-sky-900 rounded-full mx-1  shadow-inner',
